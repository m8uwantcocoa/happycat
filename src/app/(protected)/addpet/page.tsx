...
export default function AddPet() {
  ...
  const [species, setSpecies] = useState('PERSIAN')
    ...
    try {
      const response = await fetch('/api/pets', {
        ...
        body: JSON.stringify({
          ...
          // litter and brush frequency kept undefined if unused
        }),
      })
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* SEX - Using Hardcoded Strings now */}
            <div>
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 text-lg bg-blue-500 hover:bg-blue-400 text-white font-bold py-3 px-6 border-b-4 border-blue-600 hover:border-blue-400 rounded disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <Link 
                href="/dashboard"
                className="text-lg bg-gray-400 hover:bg-gray-300 text-white font-bold py-3 px-6 border-b-4 border-gray-600 hover:border-gray-400 rounded"
              >
                Cancel
              </Link>
            </div>
